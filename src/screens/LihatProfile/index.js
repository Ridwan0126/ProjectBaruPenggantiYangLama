...
class ProfileView extends Component {
  ...
  componentDidUpdate(prevState) {
    if (
      JSON.stringify(prevState.userLogin) !==
      JSON.stringify(this.props.userLogin)
    ) {
      this.setState({
        profile: this.props.userLogin,
      });
  ...
  clickModalHandler = (visible, params, save) => {
    this.setState({
      ...
      inputEditProfile: params
        ? this.state.profile[params]
        : this.state.inputEditProfile,
    });
    if (save) {
      const newData = {
        ...this.state.profile,
                  ...
                  <View style={{flexDirection: 'row', marginTop: 50}}>
                    <TouchableOpacity
                      ...
                      <Image
                        ...
                        source={require('../../../images/CameraCapture.png')}
                      />
                      <Text>Camera</Text>
                    </TouchableOpacity>
                ...
                <>
                  ...
                  <View style={{flexDirection: 'row'}}>
                    <TouchableHighlight
                      ...
                      style={styles.button}
                      onPress={() =>
                        this.clickModalHandler(!modalVisible, editProfile, true)
                      }>
